          ...
          <div className="po-contact-card">
            ...
            <div className="po-contact-list">
              <div className="po-contact-item">
                ...
                <span className="po-contact-text">195****9617</span>
              </div>

              <a href="mailto:2478554554@qq.com" className="po-contact-item">
                <span className="po-contact-icon">
                  <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                ...
                <span className="po-contact-text">2478****554@qq.com</span>
              </a>

              <a href="mailto:lujunling@163.com" className="po-contact-item">
                <span className="po-contact-icon">
                  <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                    <path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z" />
                    <polyline points="22,6 12,13 2,6" />
                ...
                <span className="po-contact-text">lujunling@163.com</span>
              </a>
            </div>
          </div>
          ...
          <div className="po-contact-card">
            ...
            {submitted ? (
              ...
              <>
                ...
                />
                <button className="po-contact-submit" onClick={handleSubmit}>
                  发送留言
                </button>
              </>
            )}
