...
const AppContent: React.FC = () => {
  ...
  const [xiaoyeAutoMsg, setXiaoyeAutoMsg] = useState<string | null>(null);
  ...
  return (
    <div className="po-root">
      ...
      <div className={`po-nav-wrap ${scrolled ? "po-nav-scrolled" : ""}`}>
        ...
        <XiaoyePanel
          isOpen={xiaoyeOpen}
          onClose={() => setXiaoyeOpen(false)}
          autoMessage={xiaoyeAutoMsg}
          onAutoMessageDone={() => setXiaoyeAutoMsg(null)}
        />
      </div>
      ...
      <style>{`
        ...
        .po-bio {
          font-size: 18px; line-height: 1.8; color: #3a4036;
