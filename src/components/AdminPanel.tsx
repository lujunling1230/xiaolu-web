...
const MODULES: ModuleDef[] = [
  ...
  { key: "lf_sports", name: "运动", icon: "🏃", description: "运动记录与健康" },
  { key: "lf_meditations", name: "冥想", icon: "🧘", description: "冥想与内心平静" },
  { key: "lf_dramas", name: "剧集", icon: "🎬", description: "追剧与影视记录" },
  { key: "lf_custom_modules", name: "自定义模块", icon: "📦", description: "用户自定义内容模块" },
