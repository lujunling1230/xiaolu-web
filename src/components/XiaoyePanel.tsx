...
const LOCAL_REPLIES: { match: (q: string) => boolean; answer: string }[] = [
  {
    ...
    answer:
      '当然啦～俊玲一共做了八个作品，除了「漫游指南」和「通关清单」，还有：\n\n🌲 森林疗愈室 — 呼吸引导、冥想空间、感恩日记，给情绪一个落脚的地方\n🏠 爱情公寓 — 用 AI 帮你看见亲密关系里的相处模式\n📦 物资管家 — 拍照识别物品，智能管理家里的每一件小东西\n💌 解忧杂货店 — 把烦恼投进去，换一个温柔的视角回来\n💊 回血清单 — 把待办变成游戏关卡，打怪升级式回血\n🌿 伴龄 — AI 养老规划伴侣，从对话到报告，把焦虑变成行动\n\n想深入了解哪个，随时告诉我呀～',
  },
  {
    match: (q) => /八个作品|七个作品|所有作品|全部作品|有哪些作品|有什么作品|做了哪些/.test(q),
    answer:
      '俊玲一共做了八个作品哦 🌿\n\n🗺️ 漫游指南 — 把旅行变成一场有温度的城市漫游\n📋 通关清单 — 用游戏化思维把人生目标变成关卡\n🌲 森林疗愈室 — 呼吸引导、冥想空间、感恩日记\n🏠 爱情公寓 — AI 视角下的亲密关系探索\n📦 物资管家 — 拍照识别，智能管理家中物品\n💌 解忧杂货店 — 把烦恼变成治愈的答案\n💊 回血清单 — 待办也能像打游戏一样有成就感\n🌿 伴龄 — AI 对话式养老规划，一键生成报告与行动建议\n\n想从哪个开始聊起呢？',
  },
  {
    match: (q) => /伴龄|养老|退休|养老金|养老规划/.test(q),
    answer:
      '伴龄是俊玲做的第八个作品，一款 AI 养老规划伴侣 🌿\n\n它最大的特点是「对话式规划」——你不需要填一堆表单，只要像和朋友聊天一样，说说你的年龄、担忧、财务状况，AI 就会一步步帮你理清思路。\n\n聊完之后，它会自动生成一份养老规划报告，包括：\n  · 核心洞察（你最需要关注什么）\n  · 关键指标（养老金缺口、储蓄目标）\n  · 可执行的行动建议（可以标记采纳）\n  · 一段温暖的寄语\n\n还有养老计算器、每日天气出行小贴士等实用工具。整体设计偏暖橙色调，像一位住在隔壁的理财顾问+心理咨询师，温暖但不焦虑。\n\n想了解它的技术实现或者设计思路吗？',
  },
];
