...
const PROJECTS = [
  ...
  { name: "解忧杂货铺", path: "/toolbox/advice", tag: "自研", desc: "治愈系问答空间" },
...
const TOOLS = [
  ...
  { name: "解忧杂货铺", icon: "🏮", desc: "治愈系问答空间", path: "/toolbox/advice" },
          ...
          <div style={{ display: "flex", justifyContent: "center" }}>
            ...
            >
              ...
              <p style={{
                ...
                森林疗愈室 · 爱情公寓 · 通关清单 · 物资管家 · 解忧杂货铺 · 漫游指南 · 回血清单 · 解压馆 · 时光博物馆 · 第七卷胶片
              </p>
              <span style={{
                fontFamily: SANS,
                fontSize: 14,
