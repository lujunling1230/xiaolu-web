  ...
  cities: [
    {
      ...
      reason: "你是陶瓷与手工艺爱好者，景德镇是中国瓷都，千年窑火不断，手工制陶体验独一无二，三宝村的艺术氛围非常适合深度探索。",
      highlights: ["古窑民俗博览区", "三宝国际陶艺村", "御窑博物馆", "瑶里古镇"],
      best_season: "春秋",
    },
    {
      name: "桂林",
      ...
      reason: "你偏好自然风光和慢节奏旅行，桂林山水甲天下的喀斯特地貌是国内顶级自然景观，漓江竹筏漂流和阳朔田园骑行体验绝佳。",
      highlights: ["漓江竹筏漂流", "阳朔十里画廊", "龙脊梯田", "象鼻山"],
      best_season: "春秋",
    },
    {
      name: "张家界",
      ...
      reason: "你对户外探险感兴趣，张家界的石英砂岩峰林是世界自然遗产，天门山玻璃栈道和百龙天梯提供震撼的视觉体验，适合喜欢挑战的旅行者。",
      highlights: ["张家界国家森林公园", "天门山玻璃栈道", "百龙天梯", "金鞭溪"],
      best_season: "春秋",
    },
  ],
  summary: "根据你的偏好（自然风光、手工艺、户外探险），推荐以上三座城市。景德镇适合深度文化体验（2-3天），桂林适合放松度假（4-5天），张家界适合户外挑战（3-4天）。",
};
